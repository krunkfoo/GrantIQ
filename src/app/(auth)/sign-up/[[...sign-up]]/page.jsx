  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-white border border-border rounded-2xl p-8 shadow-card">
        <h1 className="text-xl font-semibold text-ink mb-6 text-center">Create account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className={labelClass}>Name <span className="normal-case font-normal text-muted">— optional</span></label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className={labelClass}>Password <span className="normal-case font-normal text-muted">— min 8 chars</span></label>
            <input
              type="password"
              value={password}
        ...
        <p className="mt-5 text-center text-xs text-muted">
          ...
          <Link href="/sign-in" className="text-clay hover:text-clay-dark font-medium">
            Sign in
          </Link>
        </p>
      </div>
